...
class HNpairPlotsMM : public StdPlots{
 ...
 public:
  ...
  void Fill(snu::KEvent ev, std::vector<KLepton>& Leptons, int N_electron, int N_muon, std::vector<snu::KJet>& jets, std::vector<snu::KFatJet>& fatjets, Double_t weight, int nbjet);
