...
HNpairPlotsMM::HNpairPlotsMM(TString name): StdPlots(name){
  ...
  map_sig["h_lljjjjmass_AK8_0_SS"]    =     new TH1D("h_SS_lljjjjmass_AK8_0_"          + name,"Invariant mass of di-lepton and leading four jets",5000,0,5000);
  map_sig["h_lljjjjmass_AK8_1_SS"]    =     new TH1D("h_SS_lljjjjmass_AK8_1_"          + name,"Invariant mass of di-lepton and leading four jets",5000,0,5000);
  map_sig["h_lljjjjmass_AK8_2_SS"]    =     new TH1D("h_SS_lljjjjmass_AK8_2_"          + name,"Invariant mass of di-lepton and leading four jets",5000,0,5000);
