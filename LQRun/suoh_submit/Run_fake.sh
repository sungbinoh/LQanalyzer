...
#sktree -a Electron_FR_cal_all -S SinglePhoton -s SKTree_LeptonSkim -p B -userflag DijetPrompt -n 1 -events 1
sktree -a Electron_FR_cal_all -S SingleElectron -s SKTree_LeptonSkim -p B -userflag DijetPrompt -n 1 -events 1
